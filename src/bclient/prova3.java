...
public class prova3 implements MouseListener {
    ...
    Panel[][] grid; //names the grid of button
    ...
    public void setup(int width, int length) {
        ...
        grid = new Panel[width][length]; //allocate the size of grid
        ...
        for (int y = 0; y < length; y++) {
            for (int x = 0; x < width; x++) {
                ...
                oponent.add(opo[y][x]);
                grid[y][x].setBackground(Color.DARK_GRAY);
                opo[y][x].setBackground(Color.DARK_GRAY);
            }
        }
    ...
    public void mousePressed(MouseEvent me) {
        ...
        String command = ((Panel) me.getSource()).getName();
